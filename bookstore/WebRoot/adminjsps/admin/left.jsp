...
var bar1 = new Q6MenuBar("bar1", "菜单管理");
function load() {
	bar1.colorStyle = 2;
	...
	/* bar1.add("订单管理", "所有订单", "<c:url value='/admin/AdminOrderServlet?method=findAllOrders&state=0'/>", "body");
	bar1.add("订单管理", "未付款订单", "<c:url value='/admin/AdminOrderServlet?method=findAllOrders&state=1'/>", "body");
	bar1.add("订单管理", "已付款订单", "<c:url value='/admin/AdminOrderServlet?method=findAllOrders&state=2'/>", "body");
	bar1.add("订单管理", "未收货订单", "<c:url value='/admin/AdminOrderServlet?method=findAllOrders&state=3'/>", "body");
	bar1.add("订单管理", "已完成订单", "<c:url value='/admin/AdminOrderServlet?method=findAllOrders&state=4'/>", "body"); */
